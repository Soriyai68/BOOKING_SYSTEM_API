    ...
    range: Joi.object({
        start: Joi.number()
            ...
            .messages({
                ...
                "number.min": "Start seat number must be at least 1",
            ...
            .required()
            .messages({
                "number.base": "End must be a number",
                "number.min": "End seat number must be at least 1",
        ...
        .custom((value, helpers) => {
            if (value.start > value.end) {
                return helpers.message("Range start cannot be greater than end");
            }
            if (value.end - value.start + 1 > 15) {
                return helpers.message("Seat range limit is 15 per request");
            }
            return value;
        })
        .messages({
            "any.required": "Seat range is required",
        }),
