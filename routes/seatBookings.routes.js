...
// GET /api/seat-bookings - Get all seat bookings (Admin/SuperAdmin/Cashier via permission)
router.get(
  "/",
  authenticate,
  requirePermission("seat-bookings.view"),
...
// GET /api/seat-bookings/showtime/:id/raw - Get raw seat booking documents for a showtime (Admin/Cashier via permission)
router.get(
  "/showtime/:id/raw",
  authenticate,
  requirePermission("seat-bookings.view"),
...
// GET /api/seat-bookings/history - Get all seat booking histories (Admin/SuperAdmin/Cashier via permission)
router.get(
  "/history",
  authenticate,
  requirePermission("seat-booking-history.view"),
  validator(seatBookingSchema.getAllQuery, "query"),
